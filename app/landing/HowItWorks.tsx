...
const STEPS = [
  { n: '01', title: 'Install the extension', body: "Add clippx to Chrome in seconds. One click clips any text, image, or URL from any page you're browsing — no interruption to your flow." },
